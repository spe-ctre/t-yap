...
import walletRoutes from './wallet-money/routes/wallet.routes';
import transactionRoutes from './wallet-money/routes/transaction.routes';
import paymentRoutes from './wallet-money/routes/payment.routes';
import transferRoutes from './wallet-money/routes/transfer.routes';
import bankAccountRoutes from './wallet-money/routes/bank-account.routes';
import withdrawalRoutes from './wallet-money/routes/withdrawal.routes';
import balanceReconciliationRoutes from './wallet-money/routes/balance-reconciliation.routes';
import transactionAnalyticsRoutes from './admin/routes/transaction-analytics.routes';
import electricityRoutes from './vas/routes/electricity.routes';
import airtimeRoutes from './vas/routes/airtime.routes';
import dataRoutes from './vas/routes/data.routes';
import tvSubscriptionRoutes from './vas/routes/tv-subscription.routes';
import profileRoutes from './identity/routes/profile.routes';
import sessionRoutes from './identity/routes/session.routes';
import supportRoutes from './support/routes/support.routes';
import notificationRoutes from './identity/routes/notification.routes';
import biometricRoutes from './identity/routes/biometric.routes';
import deviceTokenRoutes from './identity/routes/device-token.routes';
import securityRoutes from './identity/routes/security.routes';
import settingsRoutes from './identity/routes/settings.routes';
import tRideRoutes from './passenger/routes/t-ride.routes';
import tripRoutes from './passenger/routes/trip.routes';
import driverRoutes from './driver/routes/driver.routes';
import agentRoutes from './agent/routes/agent.routes';
import parkManagementRoutes from './park-management/routes/park-management.routes';
import adminRoutes from './admin/routes/admin.routes';
import adminFinanceRoutes from './admin/routes/admin-finance.routes';
import { errorHandler } from './shared/middleware/error.middleware';
import { specs } from './shared/config/swagger';
import { setupCronJobs } from './shared/jobs/cron-jobs';
import twoFactorRoutes from './identity/routes/twoFactor.routes';
import auditLogRoutes from './admin/routes/auditLog.routes';
import legalRoutes from './identity/routes/legal.routes';
import kycRoutes from './identity/routes/kyc.routes';
import referralRoutes from './identity/routes/referral.routes';
import transportWalletRoutes from './passenger/routes/transport-wallet.routes';
import { requestTimeout } from './shared/middleware/timeout.middleware';
import { disconnectPrisma, prisma } from './shared/config/database';
import { appCache } from './shared/cache.service';
import { startWorkers } from './shared/workers';
